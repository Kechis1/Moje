...
public class Executor {
    ...
    void OnMessage(ExecutorMessage message) {
        if (Message != null) {
                                    ...
                                    try {
                                        ...
                                        for(Benchmark.TestResult testResult : testRun.TestResults)
                                        {
                                            if (testResult.TestId == test.Id &&
                                                ...
                                                if (testResult is Benchmark.
                                                PlanEquivalenceTestResult planEquivalenceTestResult)
                                                {
                                                    try {
